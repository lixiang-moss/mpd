...
from mpd.models.diffusion_models.dpm_solver_sampler import dpm_solver_sample_loop
from mpd.models.diffusion_models.unipc_sampler import unipc_sample_loop
...
class GaussianDiffusionModel(nn.Module, ABC):
    ...
    def conditional_sample(self, hard_conds, horizon=None, batch_size=1, method="ddpm", **sample_kwargs):
        ...
        elif method in ("dpm_solver", "dpm_solver_pp"):
            return dpm_solver_sample_loop(self, shape_x, hard_conds, **sample_kwargs)
        elif method == "unipc":
            return unipc_sample_loop(self, shape_x, hard_conds, **sample_kwargs)
        else:
            raise NotImplementedError
